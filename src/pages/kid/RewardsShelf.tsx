  ...
  return (
    <div className="px-5 pb-6 pt-8">
      <div className="flex items-center gap-2">
        ...
        <h1 className="text-2xl font-extrabold">Rewards Shelf</h1>
      </div>
      <p className="text-sm text-white/55">You have {child.points} points to spend or save.</p>
            ...
            >
              ...
              {!r.redeemed && !afford && (
                <div className="mt-3">
                  ...
                  <div className="mt-1 text-xs text-white/50">{pct}% saved</div>
                </div>
              )}
            </div>
          )
